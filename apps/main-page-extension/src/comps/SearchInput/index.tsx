...
import {
  searchEngineFactory,
  SearchEngineNameType,
} from "../../tools/search-engine/factory";
...
export function SearchInput(props: PropsWithoutRef<SearchInputProps>) {
  ...
  const handleUpdatePreviewListDebounced = useDebounce(
    handleUpdatePreviewList,
    300,
  );
    ...
    <div className={className} style={style}>
      <Input
        ...
        contentAfter={
          <SearchRegular
            onClick={handleQuery}
            className={classes["input-after"]}
          />
        }
        className={mergeClasses(
          classes.input,
          !!previewList.length && classes.inputFocusWithPreview,
        )}
        type={"text"}
